...
| **1-Week Plan** (`day01.html` … `day06.html`) | ✅ **complete, interactive, offline** | 6-day arc: adjoints → SVD/DFT → signal/k-space/SEPG → forward model → regularized inverse. Each has a widget, quiz, mastery checklist; each a distinct colour. Linked from `index.html`. |
